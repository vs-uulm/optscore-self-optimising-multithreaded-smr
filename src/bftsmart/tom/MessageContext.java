...
public class MessageContext implements Serializable {
    ...
    private EvalReqStatsServer evalReqStatsServer;

    /**
     * a global request sequence counter, managed and incremented by (UDS)ServiceReplica
     */
    private int globalReqSequence;

    public int getGlobalReqSequence() {
        return globalReqSequence;
    }

    public void setGlobalReqSequence(int globalReqSequence) {
        this.globalReqSequence = globalReqSequence;
    }

    public EvalReqStatsServer getEvalReqStatsServer() {
        return evalReqStatsServer;
    }

    public void setEvalReqStatsServer(EvalReqStatsServer evalReqStatsServer) {
        this.evalReqStatsServer = evalReqStatsServer;
    }
